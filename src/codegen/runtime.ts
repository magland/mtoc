...
export const RUNTIME_HELPERS: ReadonlyMap<string, RuntimeSnippet> = new Map([
  ...
  ["mtoc_isnan_complex", loadSnippet("isnan_complex.h")],
  ["mtoc_isinf_complex", loadSnippet("isinf_complex.h")],
  ["mtoc_isfinite_complex", loadSnippet("isfinite_complex.h")],
  ["mtoc_floor_complex", loadSnippet("floor_complex.h")],
  ["mtoc_ceil_complex", loadSnippet("ceil_complex.h")],
  ["mtoc_round_complex", loadSnippet("round_complex.h")],
  ["mtoc_trunc_complex", loadSnippet("trunc_complex.h")],
